...
const file_auth_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x17auth/auth_service.proto\x12\x04auth\x1a\x1bgoogle/protobuf/empty.proto\x1a\x15auth/auth_model.proto\"i\n" +
	...
	"\n" +
	"DeleteUser\x12\x13.auth.DeleteRequest\x1a\x16.google.protobuf.EmptyB=Z;github.com/go-microservices-maxfun4k/contracts/go/auth;authb\x06proto3"
...
var file_auth_auth_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
