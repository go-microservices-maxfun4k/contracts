...
const file_account_account_model_proto_rawDesc = "" +
	"\n" +
	"\x1baccount/account_model.proto\x12\aaccount\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd9\x01\n" +
	"\n" +
	"CreateUser\x12\x14\n" +
	...
	"\bpassword\x18\b \x01(\tR\bpassword\"\xf6\x02\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"is_deleted\x18\f \x01(\bR\tisDeletedBCZAgithub.com/go-microservices-maxfun4k/contracts/go/account;accountb\x06proto3"
